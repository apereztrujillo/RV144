...
```
  ...
  We would expect to see both graphs of equ size (50% on each dide) if the two are independent. They do not appear to be equal ..shedding doubt on the idea of independence.  
